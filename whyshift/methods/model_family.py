...
from robust_loss import get_dro_criterion, RobustLoss, group_dro_criterion, cvar_doro_criterion, chi_square_doro_criterion
...
class group_DRO():
    ...
    def fit(self, X, y, train_ratio=TRAIN_FRAC, device = device):
        self.device = device 
